...
export async function fetchCurrentProfile(): Promise<{
  ...
  try {
    ...
    const { data, error } = await supabase
      .from("profiles")
      .select(`
        id, email, full_name, display_name, headline, bio, location, avatar_url, banner_url, website_url, github_url, linkedin_url, twitter_url, portfolio_url, collaboration_readiness, is_verified, verification_type, university, profile_completion, looking_for, onboarding_completed, created_at, updated_at,
...
export async function updateProfile(
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .update(updates)
      .eq("id", user.id)
      .select("id, email, full_name, display_name, headline, bio, avatar_url, banner_url, location, website_url, github_url, linkedin_url, twitter_url, portfolio_url, collaboration_readiness, is_verified, verification_type, university, profile_completion, looking_for, onboarding_completed, created_at, updated_at")
      .single()
