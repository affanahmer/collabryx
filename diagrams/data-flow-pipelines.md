...
> Full text descriptions for each pipeline section follow below. See [`sequence-diagrams.md`](./sequence-diagrams.md) for the sequence diagram index.
...
> **See also:** [`sequence-diagrams.md`](./sequence-diagrams.md) for the full sequence diagram index, [`erd.md`](./erd.md) for queue table schemas.
